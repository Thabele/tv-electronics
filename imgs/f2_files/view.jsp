...
if (typeof usi_js === 'undefined') {
	usi_js = {
		campaign: {
			id: '13927167816660485782287',
			site_id: 57133,
			original_site_id: 57133,
			config_id: 136319,
			company_id: 5698,
			key: 'desktop_english',
			link: '',
			deep_link: 'https://shutterstock.7eer.net/c/16669/42913/1305?sharedid=Promo20%25&u=',
			domains: '',
		...
		display_vars: {
			...
			bottom: '',
			mobilefit: 0,
			background: "/chatskins/5698/Shutterstock-TT-8-23-black-dsktp-v2.jpg",
			p1: "",
			p2: "",
			intrinsic_size: {
				background: {
			...
			css: ".usi_display * {\tfont-size: 1em;\tline-height: 1.2;\tbox-sizing: border-box;\tcolor: inherit;\tfont-family: inherit;}.usi_display {\tcolor: #000;\tfont-family: inherit;}.usi_cart_header {\tposition: absolute;  top: 8%;  left: 0%;  font-size: 1.3em;  font-weight: bold;  text-align: center;  width: 33%;}.usi_header1 {  position: absolute;  top: 24%;  left: 3%;  color: #FFF;  font-size: 2.5em;  font-weight: bold;  width: 52%;  text-align: center;}.usi_header2 {  position: absolute;  top: 46%;  left: 3%;  color: #FFF;  font-size: 2.5em;  font-weight: bold;  width: 52%;  text-align: center;}/* Submit Button */.usi_submitbutton:hover, .usi_submitbutton:active, .usi_submitbutton:focus {\tbackground: #FC3441;\tborder: none;\toutline: none;}.usi_submitbutton {\tposition: absolute;\ttop: 70%;  left: 10.7%;  width: 34.2%;  height: 11%;\tmargin: 0;\tpadding: 0;\tdisplay: inline-block;\toutline: none;\tbackground: #FC3441;\tborder: none;\tcursor: pointer;  color: #FFF;  font-size: 1.5em;  font-weight: bold;\ttext-align: center;  border-radius: 50px;}/* Disclaimer */.usi_disclaimer {\tposition: absolute;\ttop: 92%;\tleft: 3%;\twidth: 52%;\ttext-align: center;\tcolor: #FFF;\tfont-size: 0.7em;}.usi_disclaimer a {\ttext-align: center;\tcolor: inherit;\tfont-size: 1em;\ttext-decoration: none !important;}",
			focus_trap: 0
		},
		timers: {
			display_timer: -1,
...
usi_js.display_vars.p1_html = [
	'<div class="usi_head usi_sr_only">Shutterstock</div>',
  '<div class="usi_header1">', usi_app.messaging.header1,'</div>',
  '<div class="usi_header2">', usi_app.messaging.header2,'</div>',
	'<div class="usi_disclaimer"><a href="https://labs.upsellit.com/privacy-policy" target="_blank">', usi_app.messaging.disclaimer, '</a></div>',
	'<button class="usi_submitbutton" onclick="usi_js.click_cta();" type="button" aria-label="Redeem Now">',usi_app.messaging.cta,'</button>',
].join('');
