		...
		usi_app.load = function () {
			...
			try {
				...
				if (!usi_app.suppress_page) {
					...
					} else if(usi_date.is_before('2025-04-01T20:59:00-07:00')) {
						usi_app.messaging = usi_app.get_messaging('message_sitewide_20percent_march25');
						var site_info = usi_app.get_campaign_details('sitewide_20percent_march25', user_type);
